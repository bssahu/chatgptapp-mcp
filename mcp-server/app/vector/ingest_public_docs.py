"""Ingest markdown files into the public Qdrant collection."""
...
async def main() -> None:
    ...
    parser.add_argument(
        "--data-dir",
        default=str(Path(__file__).resolve().parent.parent / "data" / "public_docs"),
    )
    ...
    client = get_qdrant()
    coll = settings.qdrant_public_collection
